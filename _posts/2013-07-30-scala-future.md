...
<a name="footnote1">[1]</a>: The code example is from a book called ["Learning Concurrent Programming in Scala"] (https://www.packtpub.com/application-development/learning-concurrent-programming-scala-second-edition).
